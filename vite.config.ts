...
export default defineConfig(({ mode, command }) => {
  ...
  // GitHub Pages (project site) serves this app from /notebibliche/, not from
  // the domain root. In dev mode we keep base at '/' so the local server works
  // normally; production builds get the GitHub Pages subpath unless Figma's
  // own preview infrastructure supplies FIGMA_PUBLIC_URL.
  const githubPagesBase = '/notebibliche/'
